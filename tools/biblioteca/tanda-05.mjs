...
export const TANDA_05 = [
  ...
  /* ═══ MANEJO ═══════════════════════════════════════════════ */
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'dos balones simultáneos en el sitio, sin compañero, quince segundos.',
        intermedio: 'alternos, con compañero marcando altura.',
        avanzado: 'alternos, con compañero que se desplaza y hay que seguirle, más un cambio de mano cruzando los dos balones.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'el balón se le entrega a uno y el otro llega un segundo después.',
        intermedio: 'los dos salen a la vez.',
        avanzado: 'tres jugadores a por el mismo balón.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'espacio amplio y fijo.',
        intermedio: 'el espacio se reduce cada treinta segundos.',
        avanzado: 'además hay dos jugadores sin balón que intentan tocar balones ajenos.',
      },
  ...
  /* ═══ JUEGO DE PIES ════════════════════════════════════════ */
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'andando, sin pase, solo la parada y los dos pivotes.',
        intermedio: 'en carrera con pase y compañero con manos arriba.',
        avanzado: 'la parada llega tras un cambio de dirección, que es cuando de verdad cuesta caer a la vez.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'el defensor sigue sin anticipar y la finta se hace despacio y marcada.',
        intermedio: 'defensa normal y finta a velocidad.',
        avanzado: 'el defensor puede adelantarse, con lo que a veces la respuesta correcta es la puerta atrás y no la finta de salida.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      organizacion: 'Con 12: seis parejas repartidas por la pista, sin canastas. Se cambia de rol cada treinta segundos.',
      niveles: {
        base: 'defensor pasivo que solo levanta los brazos.',
        intermedio: 'presión real y tres segundos.',
        avanzado: 'dos defensores y máximo dos segundos.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'solo salida directa, defensor estático que tapa siempre el mismo lado.',
        intermedio: 'las dos salidas, el defensor elige y lo mantiene.',
        avanzado: 'el defensor puede cambiar de lado mientras el atacante finta.',
      },
  ...
  /* ═══ REBOTE ═══════════════════════════════════════════════ */
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'el defensor no bloquea, solo va al rebote; el atacante practica salir en el tiro.',
        intermedio: 'el defensor bloquea de verdad.',
        avanzado: 'dos contra dos al rebote tras tiro del entrenador.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'dos contra dos y el entrenador avisa desde dónde tira.',
        intermedio: 'tres contra tres.',
        avanzado: 'tres contra tres y el ataque puede moverse antes del tiro, con lo que hay que encontrar al par en movimiento.',
      },
  ...
  /* ═══ CALENTAMIENTO ════════════════════════════════════════ */
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'solo dos gestos, con el balón sostenido sin manipular.',
        intermedio: 'los cuatro gestos con manipulación.',
        avanzado: 'los cuatro gestos botando con la otra mano al mismo tiempo.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'relevo simple de ida y vuelta botando.',
        intermedio: 'con tarea en el cono.',
        avanzado: 'con tarea en el cono y con la mano no dominante todo el recorrido.',
      },
     ...
     específico de verdad y D9 admite la excepción. */
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'solo el color, sin especificar pie y sin botar.',
        intermedio: 'color y pie, botando.',
        avanzado: 'dos consignas encadenadas ("azul con el derecho, luego rojo con el izquierdo") y hay que recordar las dos.',
      },
  ...
  },
  {
    ...
    requisitos: {
      ...
      niveles: {
        base: 'gestos estáticos y lentos, sin cruce (copia igual, no espejo).',
        intermedio: 'espejo con gestos estáticos.',
        avanzado: 'espejo con desplazamiento y dos gestos a la vez.',
      },
