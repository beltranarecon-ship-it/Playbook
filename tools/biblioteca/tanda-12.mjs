...
export const TANDA_12 = [
  ...
  /* ═══ SUPERIORIDADES ═══════════════════════════════════════ */
  {
    ...
    tablero: () => [
      jug('A', 1, 0.68, 0.42), jug('A', 2, 0.68, 0.62),
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.40, y: 0.46 } },
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.44, y: 0.66 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.36, y: 0.48 } },
        ] },
        { eventos: [{ jugador: 'A1', tipo: 'pase', a: 'A2' }] },
        { eventos: [
          { jugador: 'A2', tipo: 'bote', hacia: 'aro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.30, y: 0.58 } },
        ] },
  ...
  },
  {
    ...
    tablero: () => [
      jug('A', 1, 0.68, 0.50), jug('A', 2, 0.66, 0.22), jug('A', 3, 0.66, 0.78),
      jug('B', 1, M.tiro_libre[0], M.tiro_libre[1]),
      jug('B', 2, M.poste_bajo_der[0] + 0.02, 0.50),
      balon(0.68, 0.50),
    ],
    intent: {
      canasta: 'norte',
      fases: [
        ...
        { eventos: [
          ...
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.40, y: 0.22 } },
          { jugador: 'A3', tipo: 'corte', hacia: { x: 0.40, y: 0.78 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.39, y: 0.50 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'pase', a: 'A3' },
          { jugador: 'B2', tipo: 'defiende', marca: 'A3', hacia: { x: 0.29, y: 0.68 } },
        ] },
        { eventos: [
          { jugador: 'A3', tipo: 'pase', a: 'A2' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.36, y: 0.30 } },
        ] },
        { eventos: [
          { jugador: 'A2', tipo: 'bote', hacia: 'aro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.28, y: 0.36 } },
        ] },
        { eventos: [{ jugador: 'A2', tipo: 'tiro' }] },
      ],
    },
     ...
     le pase en un partido no sabrá ni mirarse. */
  {
    ...
    tablero: () => [
      ...
      jug('B', 2, M.poste_bajo_der[0] + 0.04, 0.50),
  ...
  },
  {
    ...
    tablero: () => [
      ...
      jug('B', 3, M.escolta_izq[0] - 0.05, M.escolta_izq[1]),
      jug('B', 4, 0.27, 0.74),
      cono(0.16, 0.35), cono(0.50, 0.35), cono(0.80, 0.35),
      cono(0.16, 0.66), cono(0.50, 0.66), cono(0.80, 0.66),
      balon(M.base[0], M.base[1]),
    ],
    intent: null,
  },
