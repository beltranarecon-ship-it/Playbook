...
export const TANDA_10 = [
     ...
     lo que se cuenta y lo que se celebra. */
  {
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.34, y: 0.72 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.31, y: 0.71 } },
        ] },
      ],
    },
  },
  {
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.36, y: 0.22 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.32, y: 0.26 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.30, y: 0.14 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.27, y: 0.20 } },
        ] },
      ],
    },
  },
  {
    ...
    intent: {
      ...
      fases: [
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.40, y: 0.60 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.37, y: 0.58 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.36, y: 0.40 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.33, y: 0.42 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.32, y: 0.55 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.29, y: 0.53 } },
        ] },
      ],
    },
  },
  ...
  /* ═══ 1c1 SIN BALÓN ════════════════════════════════════════ */
  {
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.42, y: 0.76 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.39, y: 0.74 } },
        ] },
        // y se corta por dentro, que es donde ya no está
        { eventos: [
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.24, y: 0.58 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.33, y: 0.68 } },
        ] },
  ...
  },
  {
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.215, y: 0.63 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.27, y: 0.62 } },
        ] },
        { eventos: [{ jugador: 'A1', tipo: 'pase', a: 'A2' }] },
        { eventos: [
          { jugador: 'A2', tipo: 'tiro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.25, y: 0.60 } },
        ] },
      ],
    },
  },
    ...
    intent: {
      ...
      fases: [
        { eventos: [
          ...
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.29, y: 0.60 } },
        ] },
  ...
  },
  {
    ...
    tablero: () => [
      jug('A', 1, 0.24, 0.30), jug('B', 1, 0.24, 0.40),
      balon(0.32, 0.50),
    ],
    intent: {
      canasta: 'norte',
      fases: [
        ...
        { eventos: [
          { jugador: 'B1', tipo: 'defiende', hacia: { x: 0.29, y: 0.47 } },
          { jugador: 'A1', tipo: 'recoge' },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.40, y: 0.62 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.36, y: 0.59 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: 'aro' },
  ...
  },
  {
    ...
    tablero: () => [
      jug('A', 1, 0.23, 0.82), jug('B', 1, 0.29, 0.79),
      balon(0.23, 0.82),
    ],
    intent: {
      canasta: 'norte',
      fases: [
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.30, y: 0.68 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.34, y: 0.70 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: 'aro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.26, y: 0.62 } },
        ] },
        { eventos: [{ jugador: 'A1', tipo: 'tiro' }] },
      ],
    },
  },
  {
    ...
    intent: {
      ...
      fases: [
        ...
        { eventos: [
          { jugador: 'A1', tipo: 'recoge' },
          { jugador: 'B1', tipo: 'defiende', hacia: { x: 0.31, y: 0.56 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: { x: 0.68, y: 0.50 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.60, y: 0.53 } },
        ] },
        { eventos: [
          { jugador: 'A1', tipo: 'bote', hacia: 'aro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A1', hacia: { x: 0.28, y: 0.52 } },
        ] },
        { eventos: [{ jugador: 'A1', tipo: 'tiro' }] },
      ],
    },
  ...
  },
  {
    ...
    intent: {
      ...
      fases: [
        { eventos: [
          { jugador: 'A2', tipo: 'corte', hacia: { x: 0.26, y: 0.34 } },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.22, y: 0.35 } },
        ] },
        { eventos: [{ jugador: 'A1', tipo: 'pase', a: 'A2' }] },
        { eventos: [
          { jugador: 'A2', tipo: 'bote', hacia: 'aro' },
          { jugador: 'B1', tipo: 'defiende', marca: 'A2', hacia: { x: 0.21, y: 0.42 } },
        ] },
        { eventos: [{ jugador: 'A2', tipo: 'tiro' }] },
      ],
    },
