...
export const TANDA_04 = [
  ...
  /* ═══ PASE ═════════════════════════════════════════════════ */
  {
    ...
    variantes: 'Base: sin defensor, practicando la trayectoria tensa por encima. Intermedio: con defensor por delante que no puede saltar. Avanzado: defensor completo más un segundo defensor que puede ayudar desde el lado contrario.',
  ...
  },
  {
    ...
    variantes: 'Base: media pista y sin perseguidor. Intermedio: pista entera con perseguidor desde el medio. Avanzado: dos receptores por lados distintos y el pasador elige, con dos perseguidores.',
    ...
    tablero: () => [
      jug('A', 1, E.esquina_der[0], 0.94),
      jug('A', 2, E.alero_izq[0], 0.70),
      jug('B', 1, E.centro[0], E.centro[1]),
      balon(E.esquina_der[0], 0.94),
    ],
    intent: {
      canasta: 'norte',
      fases: [
  ...
  },
  {
    ...
    variantes: 'Base: 5c1 en un espacio grande, y se puede devolver el pase. Intermedio: 4c2 sin devolver. Avanzado: 4c2 con máximo dos segundos con el balón y sin poder repetir receptor dos veces seguidas.',
  ...
  },
  {
    ...
    variantes: 'Base: dos atacantes y un defensor, diciendo el nombre. Intermedio: tres contra dos. Avanzado: tres contra dos y quien recibe tiene que pasar obligatoriamente a quien dijo, con lo que la lectura tiene que ser buena de verdad.',
  ...
  /* ═══ ENTRADA ══════════════════════════════════════════════ */
  {
    ...
    variantes: 'Base: el defensor solo pone las manos arriba sin contacto. Intermedio: contacto controlado en el cuerpo al saltar. Avanzado: contacto y además el atacante llega con menos velocidad, teniendo que resolver con el pie de dentro.',
  ...
  },
  {
    ...
    variantes: 'Base: sin nadie debajo, solo el recorrido y el cambio de mano. Intermedio: con un compañero con los brazos arriba. Avanzado: el que espera puede moverse un paso, y el atacante decide entre terminar directo o cambiar de mano.',
  ...
  },
  {
    ...
    variantes: 'Base: sin defensor, solo el recorrido por fondo y la finalización. Intermedio: con defensor que acompaña. Avanzado: con un segundo defensor que puede ayudar desde el poste bajo.',
  ...
  /* ═══ JUEGO DE DOS ═════════════════════════════════════════ */
  {
    ...
    variantes: 'Base: el defensor se adelanta siempre y el corte va libre. Intermedio: el defensor elige adelantarse o no, y el atacante lee. Avanzado: el pasador también decide, y si no ve la puerta atrás pierde la posesión.',
  ...
  },
  {
    ...
    variantes: 'Base: el aclarado ya está hecho al empezar y solo se juega el 1c1 con espacio. Intermedio: hay que aclarar y luego atacar. Avanzado: tres atacantes, con dos aclarando y una esquina que puede recibir.',
  ...
  },
  {
    ...
    variantes: 'Base: sin defensores, solo la mecánica de la entrega y la salida. Intermedio: con los dos defensores. Avanzado: el que entrega puede quedarse el balón y atacar él si ve que el defensor se anticipa al cruce.',
  ...
  },
  {
    ...
    variantes: 'Base: sin defensores, solo la mecánica de bloquear quieto y salir rozando. Intermedio: con los dos defensores. Avanzado: el que usa el bloqueo puede salir por los dos lados según cómo le defiendan, y el bloqueador puede abrirse o ir al aro.',
  ...
  /* ═══ CONTRAATAQUE ═════════════════════════════════════════ */
  {
    ...
    variantes: 'Base: rebote y pase de salida, sin correr la pista. Intermedio: rebote, salida y contraataque 3c2. Avanzado: rebote, salida y contraataque con los dos defensores saliendo desde media pista, lo que quita casi toda la ventaja.',
  ...
  },
  {
    ...
    variantes: 'Base: dos atacantes tiran y uno balancea contra un contraataque de uno. Intermedio: dos balancean contra tres. Avanzado: dos balancean contra tres y el tirador también tiene que volver, con lo que llegan escalonados y hay que comunicarse.',
  ...
  },
  {
    ...
    variantes: 'Base: tres carriles sin defensor, solo la forma. Intermedio: con un defensor esperando. Avanzado: con dos defensores y sin poder pasar por el centro después del medio campo.',
    ...
    tablero: () => [
      jug('A', 1, E.alero_izq[0], 0.80), jug('A', 2, E.base[0], 0.84), jug('A', 3, E.alero_der[0], 0.80),
