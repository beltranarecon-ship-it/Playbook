...
router
  ...
  /* «Rehacer la pizarra» (ESPEC-PIZARRA-v3 §11.4): un ejercicio de antes,
     abierto directamente en la Pizarra con sus posiciones iniciales. */
  .on('/ejercicios/:id/rehacer', (p) => show(wizard, { ...p, modo: 'editar', paso: 1 }))
